...
Tempo de curso: 2 meses e 12 dias

O objetivo deste projeto era testar nossos conhecimentos com o framework de testes Jest. Aqui desenvolvemos testes para as funções já criadas. Fizemos o tratamento da assincronicidade nos testes, mockamos a implementação de funções, mockamos API's, entre outras coisas.
